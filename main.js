...
module.exports = "#photo {\n  width: 200px;\n  height: 200px;\n  background-image: url(/assets/img/logo.png);\n  background-size: cover;\n  background-position: right center;\n  border-radius: 50%;\n}\n\n.padding-top {\n    padding-top: 80px;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var NpContentComponent = /** @class */ (function () {
    function NpContentComponent(route) {
        this.route = route;
    }
    NpContentComponent.prototype.ngOnInit = function () {
        this.parkUrl = this.route.snapshot.params['name'];
        var parkList = new _np_component__WEBPACK_IMPORTED_MODULE_2__["ParkList"]();
